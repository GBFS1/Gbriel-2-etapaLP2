...
<html lang="pt-br">
  ...
  <body>
      <div class="container">
        <h1 class="m">Editar Aluno</h1>
        <hr>
        
        <form name="cadastrar" method="post" action="update_aluno.php">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
        ...
        <?php
            ...
            echo"
                ...
                <p>Clique <a href='listar_aluno.php'>aqui</a> para acessar a lista de clientes cadastrados. </p>
            ";
        }
        ?>