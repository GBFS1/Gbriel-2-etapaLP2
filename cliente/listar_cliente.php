<?php 
    ...
    $slq = "select * from cliente order by nome";
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-2 icones">
                 <a href="ver_cliente.php?id=<?php echo $id?>"><img src="../img/ver.png" alt="" style="width: 20px;"></a>
                 <a href="editar_cliente.php?id=<?php echo $id?>"><img src="../img/ferramenta-lapis.png" alt="" style="width:20px;"></a>
                 <a href="excluir_cliente.php?id=<?php echo $id?>"onclick="return confirm('Confirma a Exclusão do Registro?'"><img src="../img/lixeira-de-reciclagem.png" alt="" style="width: 20px;"></a>
        </div>
        </div>
         <?php 
            }
